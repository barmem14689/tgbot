...
class Config:
    ...
    extend_paid_from_current_end: bool
    sub_expiry_warn_days: int
...
def load_config() -> Config:
    ...
    return Config(
        ...
        extend_paid_from_current_end=_env_bool("EXTEND_PAID_FROM_CURRENT_END", default=False),
        sub_expiry_warn_days=max(1, int(os.getenv("SUB_EXPIRY_WARN_DAYS", "7"))),
